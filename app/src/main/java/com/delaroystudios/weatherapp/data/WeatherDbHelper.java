...
public class WeatherDbHelper extends SQLiteOpenHelper {
     ...
     * with the Android course for a while now. Believe it or not, older versions of WeatherApp
     * still exist out in the wild. If we started this DATABASE_VERSION off at 1, upgrading older
     * versions of WeatherApp could cause everything to break. Although that is certainly a rare
