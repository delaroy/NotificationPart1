...
public final class WeatherPreferences {
    ...
    /**
     * Returns true if the user prefers to see notifications from WeatherApp, false otherwise. This
    ...
    public static boolean areNotificationsEnabled(Context context) {
        ...
        /*
         * In WeatherApp, the user has the ability to say whether she would like notifications
