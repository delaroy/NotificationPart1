...
public class WeatherSyncUtils {
    ...
    /**
     * Schedules a repeating sync of WeatherApp's weather data using FirebaseJobDispatcher.
    ...
    static void scheduleFirebaseJobDispatcherSync(@NonNull final Context context) {
        ...
        /* Create the Job to periodically sync WeatherApp */
        Job syncWeatherJob = dispatcher.newJobBuilder()
                /* The Service that will be used to sync WeatherApp's data */
                ...
                /*
                 * We want WeatherApp's weather data to stay up to date, so we tell this Job to recur.
                 */
                .setRecurring(true)
                /*
    ...
    synchronized public static void initialize(@NonNull final Context context) {
        ...
        /*
         * This method call triggers Weather to create its task to synchronize weather data
         * periodically.
         */
