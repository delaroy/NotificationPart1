...
public final class NetworkUtils {
    ...
    /*
     * WeatherApp was originally built to use OpenWeatherMap's API. However, we wanted to provide
     ...
     * 2) Later in WeatherApp, you are going to add an alternate method of allowing the user
